    ...
    <section className='py-32'>
      <div className='relative container'>
        <div className='mb-16 text-center'>
          <h1 className='text-5xl font-medium md:text-6xl'>Art Gallery</h1>
          <p className='mx-auto mt-4 max-w-xl text-lg text-muted-foreground'>
            Explore my collection of visual works spanning drawings, paintings,
            photography. Each piece reflects my passion for capturing beauty in
            both the natural world and human experience.
          </p>
        </div>
